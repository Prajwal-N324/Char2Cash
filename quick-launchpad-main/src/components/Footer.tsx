  ...
  <footer className="bg-primary text-primary-foreground py-12">
    <div className="container mx-auto px-4">
      <div className="grid md:grid-cols-4 gap-8">
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-display text-lg font-bold">BioCharHub</span>
          </div>
          <p className="text-sm text-primary-foreground/70">
            Turning agricultural waste into climate wealth. Empowering farmers, enabling investors, saving the planet.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="space-y-2 text-sm text-primary-foreground/70">
            ...
            <Link to="/signin?role=farmer" className="block hover:text-primary-foreground transition-colors">For Farmers</Link>
            <Link to="/signin?role=investor" className="block hover:text-primary-foreground transition-colors">For Investors</Link>
          </div>
        </div>
      ...
      <div className="border-t border-primary-foreground/20 mt-8 pt-8 text-center text-sm text-primary-foreground/50">
        © 2026 BioCharHub. All rights reserved. Building a greener tomorrow.
      </div>
    </div>
  </footer>
);
